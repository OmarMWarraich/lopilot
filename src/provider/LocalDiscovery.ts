...
import { fetchOllamaModels as fetchOllamaModelsFromConnector } from "../adapter";
import { ModelMetadata } from "../adapter/types";
...
export async function fetchOllamaModels(
  ...
  return fetchOllamaModelsFromConnector(baseUrl, timeoutMs);
}
